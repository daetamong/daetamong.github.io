...
추천 로직은 크게 1) latent factor를 계산하여 추천하는 방식과 2) 분류/회귀를 통해 추천하는 방식이 있다. 대표적인 방법은 SVD(특이점 분해, Single Value Decomposition)나, PCA를 사용할 수 있다. (이 개념들도 추후에 정리할 예정이다!)
